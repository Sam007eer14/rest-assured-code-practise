...
public class CreateJobBean {
	...
	@CsvBindByName(column = "customer_product__doop")
	private String customer_product__doop;
	...
	public CreateJobBean(String mst_service_location_id, String mst_platform_id, String mst_warrenty_status_id,
			...
			String customer_product__doop, String customer_product__serial_number, String customer_product__imei1,
		...
		this.customer_product__doop = customer_product__doop;
	...
	public String getCustomer_product__doop() {
		return customer_product__doop;
	}

	public void setCustomer_product__doop(String customer_product__doop) {
		this.customer_product__doop = customer_product__doop;
	}
	...
	public String toString() {
		return "CreateJobBean [mst_service_location_id=" + mst_service_location_id + ", mst_platform_id="
				...
				+ customer_address__state + ", customer_product__doop=" + customer_product__doop
